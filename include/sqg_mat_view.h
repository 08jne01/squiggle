...
namespace sqg
{
    ...
    struct row_view
    {
        ...
        row_view& operator=( const V& vector )
        {
            assign(*this, vector);
            return *this;
        }
    ...
    struct col_view
    {
        ...
        template<detail::vec_type V>
        col_view& operator=( const V& vector )
        {
            assign(*this, vector);
            return *this;
        }
    ...
    void assign( row_view<M,row> view, const V& vector )
    {
        X(view) = X(vector);
        Y(view) = Y(vector);
    }
    ...
    read_row_view<T,row_index> row( const T& matrix )
    {
        return {matrix};
    }
    ...
    void assign( col_view<M,col> view, const V& vector )
    {
        X(view) = X(vector);
        Y(view) = Y(vector);
    }
    ...
    read_col_view<T,col_index> col( const T& matrix )
    {
        return {matrix};
    }
    ...
    template<detail::mat_type M>
    transposed_view<M> transposed( const M& matrix )
    {
        return {matrix};
    }
}